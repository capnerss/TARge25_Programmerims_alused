...
def generate_string_with_random_length(threshold: float) -> str:
    ...
    """
    string_with_random_length = ""
    random_number = random.random()
    while random_number < threshold:
        random_number = random.random()
        string_with_random_length = string_with_random_length + "-"
    return string_with_random_length
...
if __name__ == '__main__':
    ...
    print(generate_string_with_random_length(0.4))
